...
class TrackerHandler(BaseHTTPRequestHandler): # Handle requests from other peers
    ...
    def handle_http(self, status_code, path):
        ...
        content = json.dumps({"message": messages_list[message_id]["message_content"], "message_id": message_id, "signature": messages_list[message_id]["signature"], "protocol_version": "1", "fingerprint": messages_list[message_id]["fingerprint"]})
