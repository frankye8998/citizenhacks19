...
class TrackerHandler(BaseHTTPRequestHandler): # Handle requests from other peers
    ...
    def handle_http(self, status_code, path):
        ...
        content = json.dumps({"message": messages_list[message_id.decode()]["message_content"], "message_id": message_id.decode(), "signature": messages_list[message_id.decode()]["signature"], "protocol_version": "1", "fingerprint": messages_list[message_id.decode()]["fingerprint"], "pub_key": messages_list[message_id.decode()]["pub_key"]})
